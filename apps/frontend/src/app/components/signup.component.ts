...
@Component({
  ...
  template: `
      ...
      <div class="auth-desktop">
        ...
        <div class="auth-form-panel">
          <div class="auth-form-wrapper">
            ...
            <p class="type-body auth-subtitle">Trois minutes pour démarrer ta première routine.</p>
    ...
    <ng-template #formContent>
      <!-- Google button -->
      <button class="btn btn-secondary btn-lg google-btn" (click)="googleSignup()" type="button">
      ...
      <form [formGroup]="signupForm" (ngSubmit)="onSubmit()">
        ...
        <div class="form-field">
          ...
          <input
            ...
            [class.input-invalid]="signupForm.get('email')?.invalid && signupForm.get('email')?.touched"
          />
        ...
        <div class="form-field">
          ...
          <input
            ...
            placeholder="••••••••"
            [class.input-invalid]="signupForm.get('password')?.invalid && signupForm.get('password')?.touched"
          />
        ...
        <div class="form-field">
          ...
          <input
            ...
            placeholder="••••••••"
            [class.input-invalid]="signupForm.get('confirmPassword')?.touched && signupForm.hasError('passwordMismatch')"
          />
        ...
        <label class="cgu-label">
          ...
          <span>J'accepte les <a class="cgu-link" href="#">conditions</a> et la politique de confidentialité.</span>
        </label>

        <button type="submit" class="btn btn-primary btn-lg submit-btn" [disabled]="signupForm.invalid || loading">
          @if (loading) { <span>Création...</span> } @else { <span>Créer mon compte</span> }
        </button>
      </form>
...
export class SignupComponent {
  ...
  onSubmit(): void {
    ...
    const { confirmPassword, acceptCgu, ...registerData } = this.signupForm.value;
